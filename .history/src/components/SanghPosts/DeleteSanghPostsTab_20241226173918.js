...
import { fetchPostsWithSangh, deletePost } from '../../services/postService'; // Import service calls
...
const DeleteSanghPostsTab = ({ configData }) => {
    ...
    const loadPosts = async () => {
        ...
        setIsLoading(true);
        try {
            const fetchedPosts = await fetchPostsWithSangh(selectedcategory, selectedSangh, true);
